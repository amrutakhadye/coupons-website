	...
	<div id="wrapper"> <!-- start of full-container -->
		<div class="container-inner">
			<div class="row">
				...
				<h3><p><?php print $_SESSION['display_name']; ?>, we are sorry to hear that you want to leave us. We would really appreciate if you could <a href="http://dev2couponz.dailyretailcouponz.com/contact-us.php">let us know</a> the reason so that we could improve on our end.</p>
