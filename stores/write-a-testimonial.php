...
$username = $_SESSION['username'];
	...
	$add_message=mysql_query("INSERT INTO testimonial(full_name,message,username) VALUES('$full_name','$message','$username')");
		...
		{	
			...
			$body  =  "Thank you for submitting the testimonial."."\n";
			$body .="\n";
			...
			<div class="row">
				...
				<!-- menu for all the pages -->
					...
					<div id="myaccountdetails">
						...
						<p><span><?php print $_SESSION['display_name']; ?></span>, we really appreciate your efforts to write an testimonial for us. You can view all testimonials <a href="http://dev2couponz.dailyretailcouponz.com/testimonial.php">here</a></p>
						</div>
					...
					<div class="myaccount-tabs">
						<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu">
							...
							<li>
								<a class="current-tab" href="http://dev2couponz.dailyretailcouponz.com/write-a-testimonial.php">Write A Testomonial</a>
							</li>
							<li>
