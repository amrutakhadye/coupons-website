...
if (isset($_POST['insert'])){
	...
	if(($_POST['sub_review'])=='1') //this if will take place only if the value of input is set to 1, then it will first update the sub_review in submitted_coupon table and then insert the same coupon in main coupons table
	{
				...
				if($InsertQuery){
					echo '<script language="javascript">';
					echo 'alert("Coupon Updated Sucessfully in Main Coupons table")';
					echo '</script>';
				...
				<div class="row">
						...
						<div class="col-9">
							...
							<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu emp-account-tabs">
								...
								<li>
									<a class="current-tab" href="http://dev2couponz.dailyretailcouponz.com/submitted-coupons.php">Submitted Coupons By Users</a>
								</li>
								<li>
												 ...
												 <form action="submitted-coupons.php" method="POST">
													...
													<p>
														<span class="submittedcoupons-expirydate">
															...
															<p><p class="single-deal-expiry"><strong>Reviewed/Inserted: </strong><input id="sub_review" name="sub_review" type="text" value="<?php echo $row['submitted_reviewed']; ?>"/></p></p> 
