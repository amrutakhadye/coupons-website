	...
	<aside>
		...
		<h3>Statistics</h3>
		 ...
		 <?php
			...
			<p>
				<span class="active-inactive">
					Total Coupon(s): <strong><?php echo mysql_result(mysql_query("SELECT COUNT(`coupon_code`) FROM `coupon`"),0);?></strong>
				</span>
			</p>
			<p>
			...
			<p>
				<span class="active-inactive">Inactive Coupon(s) Found: <strong><?php echo $inactive_count;?></strong></span>
			</p>
