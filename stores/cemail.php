...
$email2=stripslashes(trim($_POST['email2']));// retype the new email
	...
	{
		if($current_email==$_SESSION['email'])//Checks if the current email is correct or not
			{
				...
				<!-- menu for all the pages -->
					...
					<div class="myaccount-tabs">
						<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu">
							...
							<li>
								<a class="current-tab" href="http://dev2couponz.dailyretailcouponz.com/cemail.php">Change Email</a>
							</li>
							<li>
