				...
				<!-- menu for all the pages -->
					...
					<div class="myaccount-tabs">
						<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu">
							...
							<li>
								<a class="current-tab" href="http://dev2couponz.dailyretailcouponz.com/submit-a-coupon.php">Submit A Coupon</a>
							</li>
							<li>
					...
					<p class="form_success_info"><?php  echo  $info_success_email; ?></p>
						...
						<div id="change-password">	
							...
							<form action="submit-a-coupon.php" method="post">
								...
								<p><span class="customformtitle">Store Name: </span><input name="store_name" type="text"/><br /></p>
								<!--Input data for Coupon Title-->
								<p><span class="customformtitle">Coupon Title: </span><input type="text" name="coupon_title" size="11" /><br/></p>
								<!--Input data for Coupon Code-->
								<p><span class="customformtitle">Couple Code: </span><input type="text" name="coupon_code" size="11"><br /></p>
								<!--Input data for Coupon Description-->
								<p><span class="customformtitle">Coupon Description: </span><input type="text" name="description" size="11" /><br /></p>
								<!--Input data for Coupon Link-->
								<p><span class="customformtitle">Coupon Link: </span><input type="text" name="coupon_link" size="30" /><br /></p>
								<!--Input data for Coupon Expriy Date-->
								<p><span class="customformtitle">Coupon Expiry Date: </span><input type="date" name="expiry_date" size="11" /><br /></p>
