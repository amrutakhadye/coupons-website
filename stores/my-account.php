			...
			<div class="row">
				...
				<div class="col-12">
					<div id="single-page-layout">
						...
						<p>Welcome to Daily Retail Couponz. We are really happy to have you on board with us.</p>
					...
					<div class="myaccount-tabs">
						<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu">
							...
							<li>
								<a class="" href="http://dev2couponz.dailyretailcouponz.com/cemail.php">Change Email</a>
							</li>
							<li>
								<a class="" href="http://dev2couponz.dailyretailcouponz.com/write-a-testimonial.php">Write A Testomonial</a>
							</li>
							<li>
								<a class="" href="http://dev2couponz.dailyretailcouponz.com/submit-a-coupon.php">Submit A Coupon</a>
							</li>
							<li>
								<a class="" href="http://dev2couponz.dailyretailcouponz.com/my-submitted-coupons.php">My Submitted Coupons</a>
							</li>
					...
					<!-- content for my account page -->
						<p><span class="customformtitle">Name: </span><b style="font-size:18px;"><?php print $_SESSION['display_name'];//to diplay the display name  ?></p>
						<p><span class="customformtitle">Username: </span><b style="font-size:18px;"><?php print $_SESSION['username'];//to diplay the name ?></p>
						<p><span class="customformtitle">Registered Email Address: </span><b style="font-size:18px;"><?php echo $email_id;//to diplay the email; ?></p>
						<br>
						<p><span class="showcouponbtn"><a href="http://dev2couponz.dailyretailcouponz.com/logout.php">Logout</a></span>
						<span class="showcouponbtn"><a href="http://dev2couponz.dailyretailcouponz.com/delete-account.php">Delete Account</a></span></p><br>
				</div>
			</div>
			</div>
		</div>
