		...
		<div class="container-inner"> 
				...
				<div class="row">
						...
						<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu">
							...
							<li>
								<a class="" href="http://dev2couponz.dailyretailcouponz.com/my-wishlist.php">Wishlist</a>
							</li>
							<li>
								<a class="current-tab" href="http://dev2couponz.dailyretailcouponz.com/my-submitted-coupons.php">My Submitted Coupons</a>
							</li>
